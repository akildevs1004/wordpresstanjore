			...
			<fieldset class="adminform">
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						...
						<!-- <div class="vbo-param-container">
							<div class="vbo-param-label">api_room_id</div>
							<div class="vbo-param-setting"><input type="text" name="api_room_id" value="<?php echo count($row) ? htmlspecialchars($row['api_room_id']) : ''; ?>" size="40" /></div>
						</div> -->
						<div class="vbo-param-container">
