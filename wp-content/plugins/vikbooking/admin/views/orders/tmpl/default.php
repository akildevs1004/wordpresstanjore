		...
		<table cellpadding="4" cellspacing="0" border="0" width="100%" class="table table-striped vbo-bookingslist-table">
			<thead>
				<tr>
					...
					<th class="title left" width="200"><span>HMS Reservation Number</span></th>
			...
			?>
				...
				<tr class="row<?php echo $kk; ?>">
					...
					<td class="searchable center  " style="font-weight:bold"> <?php echo  $row['hms_api_reservation_number'] ?></td>
					<td class="center">
						<?php
	...
	jQuery(function() {
		...
		jQuery('.vbo-bookslist-snapshot').on('click', function(e) {
			...
			VBOCore.handleDisplayWidgetNotification({
				...
				booking_id: jQuery(this).attr('data-bid')
			});
		});
			...
			<div class="vbo-gen-invoices-helper" style="display: none;">
				<form action="index.php?option=com_vikbooking" method="post" id="vbo-geninv-form">
					...
					<div class="vbo-calendar-cfield-entry">
						...
						<span><select id="invoice_send" name="invoice_send">
								<option value=""><?php echo JText::translate('VBNO'); ?></option>
								<option value="1"><?php echo JText::translate('VBYES'); ?></option>
							</select></span>
					</div>
