...
$acf_more_tools_link                = acf_add_url_utm_tags( 'https://www.advancedcustomfields.com/developer/', 'bx_prod_referral', 'acf_free_plugin_cta_panel_logo', false, 'acf_plugin', 'referral' );
$acf_wpengine_logo_link             = acf_add_url_utm_tags( 'https://www.advancedcustomfields.com/', 'bx_prod_referral', 'acf_free_plugin_cta_panel_logo', false, 'acf_plugin', 'referral' );
?>
	...
	<div class="acf-field-group-pro-features-footer-wrap">
		<div class="acf-field-group-pro-features-footer">
			...
			<div class="acf-more-tools-from-wpengine">
				<a href="<?php echo $acf_more_tools_link; ?>" target="_blank"><?php esc_html_e( 'More Tools from ACF', 'acf' ); ?> <i class="acf-icon acf-icon-arrow-up-right"></i></a>
			</div>
		</div>
	</div>
</div>
